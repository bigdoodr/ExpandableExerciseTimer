...
struct OnboardingView: View {
    ...
    private let steps: [OnboardingStep] = [
        ...
        OnboardingStep(
            ...
            color: .indigo,
            title: "Export & Import",
            description: "Tap the share icon (\u{2191}) in the toolbar to export your exercises as a JSON file — great for backups or sharing. Tap the download icon (\u{2193}) to import exercises from a file."
        ),
        OnboardingStep(
            symbol: "play.circle.fill",
            color: .green,
            title: "Ready to Train!",
            description: "Tap \"Start Workout\" to begin. The timer guides you through each exercise and rest period. You can also start and control your workout from an Apple Watch."
        )
    ]
